...
\chapter{Symbolic Search}
    ...
    \section{SMT}
        ...
        \subsection{Denali: A Goal-directed Superoptimizer}
            ...
            % FIXME it would be good to explain the mapping of E-graph to SAT clause
        ...
        \subsection{Unbounded Superoptimization}
            ...
            \footnotetext{
            GCC is the Gnu Compiler Collection (originally, the Gnu C Compiler; it now supports many languages), one of the highest-quality optimizing compilers for C programs.
...
\chapter{Stochastic Search}
    ...
    \subsection{Conditionally Correct Superoptimization}
        ...
        \footnotetext{ICC is the Intel C Compiler.}
...
% work on transitions around chapters
    % introduction and conclusion for each, 
    % make sure the background information sets up the reader to understand what comes after
